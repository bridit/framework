...
namespace Bridit\Framework\Foundation;

use Bridit\Framework\Foundation\Log\Logger;
use Carbon\Carbon;
...
class Application extends Container
{
  ...
  {
    $this->serviceProviders[] = new \Bridit\Framework\Foundation\Database\EloquentServiceProvider();
