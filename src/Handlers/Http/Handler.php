...
namespace Bridit\Framework\Handlers\Http;

use Slim\App;
use Exception;
use Bridit\Framework\Http\Request;
use DI\Bridge\Slim\Bridge as SlimBridge;
use Bridit\Framework\Handlers\Exceptions\ShutdownHandler;
use Bridit\Framework\Handlers\Exceptions\HttpErrorHandler;
use Bridit\Framework\Http\Middleware\BodyParsingMiddleware;

class Handler extends \Bridit\Framework\Handlers\Handler
{
